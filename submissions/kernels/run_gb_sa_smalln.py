...
def main() -> None:
    ...
    parser.add_argument("--sa-range", default="1-80")
    parser.add_argument("--sa-iter", type=int, default=2500000)
    parser.add_argument("--sa-hours", type=float, default=11.5)
    parser.add_argument("--sa-tstart", type=float, default=15.0)
    parser.add_argument("--sa-tend", type=float, default=0.005)
    ...
    parser.add_argument("--out-dir", default="/kaggle/working/gb_sa_smalln")
